    ...
    <div className="aboutus">
      ...
      <div style={{ height: "75vh" }} className={`${test.paragraph}`}>
        ...
        <ul>
          <li>
            <p>
              BINGO12&nbsp;offer Social &nbsp;games &nbsp;that simulate real
              money&nbsp;games but do not offer prizes of monetary value.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              BINGO12 resereve the right to delete account of user who
              disrecpect otheres on the chat or from any other reason&nbsp;
            </p>
          </li>
        </ul>
      </div>
