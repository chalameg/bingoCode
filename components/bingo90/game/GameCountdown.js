...
import style from "../../../styles/bingo90/gameCountDown.module.css";
  ...
  return (
    <div className={style.container}>
      <h2 className={style.title}>
        NEXT GAME
        <span className={style.subTitle}> &nbsp;IN</span>
      </h2>
      <div
        className={`${style.countdown} h-100 flex flex-1 justify-center align-center`}
      >
        <CountdownCircleTimer
          ...
          colors={"#273fa3"}
        >
          {({ remainingTime }) => countdown_return(remainingTime)}
        </CountdownCircleTimer>
      </div>
    </div>
  );
